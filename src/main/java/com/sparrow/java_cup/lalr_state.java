 ...
 *
 * @see     com.sparrow.java_cup.lalr_item
 * @see     com.sparrow.java_cup.lalr_item_set
 * @see     com.sparrow.java_cup.lalr_transition
...
public class lalr_state {
   ...
   * @see   com.sparrow.java_cup.lalr_item_set#compute_closure
   * @see   com.sparrow.java_cup.lalr_state#propagate_all_lookaheads
   */
