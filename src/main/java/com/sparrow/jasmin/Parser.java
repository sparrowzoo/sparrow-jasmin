    ...
    public final symbol CUP$do_action(
        ...
        switch (CUP$act_num) {
            ...
            case 79: // simple_instruction ::= Insn Num
            {
                ...
                classFile.plant((/*i*/(str_token) CUP$stack.elementAt(CUP$top - 1)).str_val, (/*n*/(NumToken) CUP$stack.elementAt(CUP$top - 0)).num_val);
            ...
            {
                CUP$result = new symbol(/*set_expr*/31);
                scanner.dict.put((/*name*/(str_token) CUP$stack.elementAt(CUP$top - 1)).str_val, (/*v*/(NumToken) CUP$stack.elementAt(CUP$top - 0)));
            }
            return CUP$result;
            ...
            case 39: // item ::= Str
            {
                CUP$result = new VarToken(/*item*/3);
                ((VarToken) CUP$result).var_val = (/*s*/(str_token) CUP$stack.elementAt(CUP$top - 0)).str_val;
            }
            return CUP$result;
            ...
            {
                CUP$result = new VarToken(/*item*/3);
                ((VarToken) CUP$result).var_val = (/*n*/(NumToken) CUP$stack.elementAt(CUP$top - 0)).num_val;
            }
            return CUP$result;
            ...
            {
                CUP$result = new VarToken(/*item*/3);
                ((VarToken) CUP$result).var_val = new Integer((/*i*/(int_token) CUP$stack.elementAt(CUP$top - 0)).int_val);
            }
            return CUP$result;
            ...
            {
                CUP$result = new VarToken(/*optional_default*/2);
                ((VarToken) CUP$result).var_val = null;
            }
            return CUP$result;
            ...
            {
                CUP$result = new VarToken(/*optional_default*/2);
                ((VarToken) CUP$result).var_val = (/*v*/(VarToken) CUP$stack.elementAt(CUP$top - 0)).var_val;
            }
            return CUP$result;
            ...
            case 34: // field_spec ::= DFIELD access Word Word optional_default SEP
            {
                ...
                classFile.addField((short) (/*a*/(int_token) CUP$stack.elementAt(CUP$top - 4)).int_val, (/*name*/(str_token) CUP$stack.elementAt(CUP$top - 3)).str_val, (/*sig*/(str_token) CUP$stack.elementAt(CUP$top - 2)).str_val,
                        (/*v*/(VarToken) CUP$stack.elementAt(CUP$top - 1)).var_val);
